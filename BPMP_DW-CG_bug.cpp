...
bool USE_GA_FOR_INIT_SOL = true; // the experiment shows that a good initial solution doesn't reduce the number of iterations of sub-problem
...
bool addNodeInaccNeighbors = false;
