#ifndef DOMINANCE_DOUBLEB2D_VECTOR_H
#define DOMINANCE_DOUBLEB2D_VECTOR_H
        ...
        for (auto &node : E_toBeTreatedNodesSetCopy) //===> LINE 9 in ESPPRC(p)
        {
            ...
            for (int succ = 0; succ < n; succ++) //===> LINE 10 in ESPPRC(p)
            {
                ...
                //========> EFF function in LINE 15 and 16 in ESPPRC(p) PSEUDO-CODE <========
                {
                    ...
                    // vector<vector<double>> dominatedNewLabelSet;
                    // vector<vector<double>> dominatedExistingLabelSet;
                    ...
                    //             {
                    //                 dominatedNewLabelSet.push_back(newLabel);
                    ...
                    //             {
                    //                 dominatedExistingLabelSet.push_back(oldLabel);
                    ...
                    // {
                    //     auto it = find(bigLambda_allNodesLableSet[succ].begin(), bigLambda_allNodesLableSet[succ].end(), labelTemp);
                    //     if (it != bigLambda_allNodesLableSet[succ].end())
                    //         bigLambda_allNodesLableSet[succ].erase(it);
                    // }
                    // // bigLambda_allNodesLableSet[succ].erase(labelTemp);

                    // for (auto &labelTemp : dominatedNewLabelSet)
                    // {
                    //     auto it = find(F_nodeSuccLabelSet.begin(), F_nodeSuccLabelSet.end(), labelTemp);
                    //     if (it != F_nodeSuccLabelSet.end())
                    //         F_nodeSuccLabelSet.erase(it);
                    // }
