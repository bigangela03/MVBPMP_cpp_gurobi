//this version is the old version of LR for same start node
//this version doesn't have openMP feature
//also no feature of adding potential arcs, which is added in openMP version
...
int main(int argc, char *argv[])
{
	...
	// 	int j = c.end;
	// 	printf("profit(%d, %d) = %lf  dis:%lf  wt: %lf\n",
	// 				 i, j, c.potentialProfit, dis[i][j], wt[i][j]);
	// }
	...
	for (int i = 0; i < ceil(numPositivePotentialProfit * 0.1); i++)
	{
